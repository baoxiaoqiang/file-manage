...
/**
 * @Description IMPORT_CDS_CUPBOARD_COMPONENT_TI 
 * @Author bxq
 * @Date 2020-04-21 
**/
@Data
@ApiModel("IMPORT_CDS_CUPBOARD_COMPONENT_TI")
@Table(name = "IMPORT_CDS_CUPBOARD_COMPONENT_TI")
public class CdsCupboardComponentTi extends BasicBean implements Serializable {
