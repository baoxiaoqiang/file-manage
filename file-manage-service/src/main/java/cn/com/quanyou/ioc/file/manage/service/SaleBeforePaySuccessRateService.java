...
import cn.com.quanyou.ioc.file.manage.dao.ISaleBeforePaySuccessRateImportDao;
...
@Service
@Slf4j
public class SaleBeforePaySuccessRateService  extends ExcelImportService implements IExcelImportService<PaySuccessRateBean> {

    @Autowired
    private ISaleBeforePaySuccessRateImportDao importDao;
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<PaySuccessRateBean> excelUtils = new ExcelUtilsMap<>(PaySuccessRateBean.class,this);
    ...
    public List<AnalysisTaskErrorBean> relationDataCheck(List validList, List unvalidList, List entityList) {
        ...
        List<PaySuccessRateBean> list = entityList;

        List<ShopBasicInfoBean> basicList = shopBasicDao.queryAllFormal();

        for(PaySuccessRateBean entity : list){
...
//            }
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<PaySuccessRateBean> beanUtils = new BeanUtils<>(PaySuccessRateBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<PaySuccessRateBean>, String> search(SearchParamVo searchParamVo, PageInfo<PaySuccessRateBean> pageInfo) {
        return null;
    }
}
