...
import cn.com.quanyou.ioc.file.manage.dao.ITransportationCostsImportDao;
...
@Service
@Slf4j
public class TransportationCostsService extends ExcelImportService implements IExcelImportService<TransportationCostsBean> {

    @Autowired
    private ITransportationCostsImportDao importDao;
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<TransportationCostsBean> excelUtils = new ExcelUtilsMap<>(TransportationCostsBean.class,this);
    ...
    public List<AnalysisTaskErrorBean> relationDataCheck(List validList, List unvalidList, List entityList) {
        ...
        List<TransportationCostsBean> list = entityList;


        for(TransportationCostsBean entity : list){
            ...
            ResultInfo<AnalysisTaskErrorBean,String > dateCheckResult = super.checkReportDate(entity.getReportDate(),entity.getTranDate(),entity.getTaskId(),entity.getRowNumber(),"时间");
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<TransportationCostsBean> beanUtils = new BeanUtils<>(TransportationCostsBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<TransportationCostsBean>, String> search(SearchParamVo searchParamVo, PageInfo<TransportationCostsBean> pageInfo) {
        List<TransportationCostsBean> dataList = importDao.search(searchParamVo,pageInfo.getStartRow(),pageInfo.getEndRow());
        ...
        ResultInfo<PageInfo<TransportationCostsBean>, String> resultInfo = new ResultInfo<>();
