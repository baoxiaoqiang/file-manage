...
import cn.com.quanyou.ioc.file.manage.dao.ISaleTargetMonthImportDao;
...
@Service
@Slf4j
public class SaleTargetMonthService extends ExcelImportService implements IExcelImportService<SaleTargetMonthBean> {

    @Autowired
    private ISaleTargetMonthImportDao importDao;
    ...
    public List<AnalysisTaskErrorBean> relationDataCheck(List validList, List unvalidList, List entityList) {
        ...
        List<SaleTargetMonthBean> list = entityList;
        for(SaleTargetMonthBean entity : list){
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<SaleTargetMonthBean> excelUtils = new ExcelUtilsMap<>(SaleTargetMonthBean.class,this);
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<SaleTargetMonthBean> beanUtils = new BeanUtils<>( SaleTargetMonthBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<SaleTargetMonthBean>, String> search(SearchParamVo searchParamVo, PageInfo<SaleTargetMonthBean> pageInfo) {
        List<SaleTargetMonthBean> dataList = importDao.search(searchParamVo,pageInfo.getStartRow(),pageInfo.getEndRow());
        ...
        ResultInfo<PageInfo<SaleTargetMonthBean>, String> resultInfo = new ResultInfo<>();
