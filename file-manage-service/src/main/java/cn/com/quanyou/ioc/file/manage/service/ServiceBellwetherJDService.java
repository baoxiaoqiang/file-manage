...
import cn.com.quanyou.ioc.file.manage.dao.IServiceBellwetherJDImportDao;
...
@Service
@Slf4j
public class ServiceBellwetherJDService extends ExcelImportService implements IExcelImportService<ServiceBellwetherJDBean> {

    @Autowired
    private IServiceBellwetherJDImportDao importDao;
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<ServiceBellwetherJDBean> excelUtils = new ExcelUtilsMap<>(ServiceBellwetherJDBean.class,this);
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<ServiceBellwetherJDBean> beanUtils = new BeanUtils<>(ServiceBellwetherJDBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<ServiceBellwetherJDBean>, String> search(SearchParamVo searchParamVo, PageInfo<ServiceBellwetherJDBean> pageInfo) {
        List<ServiceBellwetherJDBean> dataList = importDao.search(searchParamVo,pageInfo.getStartRow(),pageInfo.getEndRow());
        ...
        ResultInfo<PageInfo<ServiceBellwetherJDBean>, String> resultInfo = new ResultInfo<>();
