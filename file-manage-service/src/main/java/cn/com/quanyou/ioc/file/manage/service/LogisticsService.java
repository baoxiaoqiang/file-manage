...
import cn.com.quanyou.ioc.file.manage.dao.ILogisticsImportDao;
...
@Service
@Slf4j
public class LogisticsService extends ExcelImportService implements IExcelImportService<LogisticsBean> {

    @Autowired
    private ILogisticsImportDao importDao;
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<LogisticsBean> excelUtils = new ExcelUtilsMap<>(LogisticsBean.class,this);
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<LogisticsBean> beanUtils = new BeanUtils<>(LogisticsBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<LogisticsBean>, String> search(SearchParamVo searchParamVo, PageInfo<LogisticsBean> pageInfo) {
        List<LogisticsBean> dataList = importDao.search(searchParamVo,pageInfo.getStartRow(),pageInfo.getEndRow());
        ...
        ResultInfo<PageInfo<LogisticsBean>, String> resultInfo = new ResultInfo<>();
