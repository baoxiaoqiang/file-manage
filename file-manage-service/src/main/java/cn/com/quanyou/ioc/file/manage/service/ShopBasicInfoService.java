...
@Service
@Slf4j
public class ShopBasicInfoService extends ExcelImportService implements IExcelImportService<ShopBasicInfoBean> {

    @Autowired
    private IShopImportBasicInfoImportDao importDao;
    ...
    public void importExcel(AnalysisTaskBean task, ExcelModel excelModel) {
        ...
        ExcelUtilsMap<ShopBasicInfoBean> excelUtils = new ExcelUtilsMap<>(ShopBasicInfoBean.class,this);
    ...
    public List<AnalysisTaskErrorBean> relationDataCheck(List validList, List unvalidList, List entityList) {
        ...
        List<ShopBasicInfoBean> list = entityList;
        for(ShopBasicInfoBean entity : list){
    ...
    public void dataValidate(String taskId,String loginUser) {
        ...
        BeanUtils<ShopBasicInfoBean> beanUtils = new BeanUtils<>(ShopBasicInfoBean.class);
    ...
    @Override
    public ResultInfo<PageInfo<ShopBasicInfoBean>, String> search(SearchParamVo searchParamVo, PageInfo<ShopBasicInfoBean> pageInfo) {
        List<ShopBasicInfoBean> dataList = importDao.search(searchParamVo,pageInfo.getStartRow(),pageInfo.getEndRow());
        ...
        ResultInfo<PageInfo<ShopBasicInfoBean>, String> resultInfo = new ResultInfo<>();
