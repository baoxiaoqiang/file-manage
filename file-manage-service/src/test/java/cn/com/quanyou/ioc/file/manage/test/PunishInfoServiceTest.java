...
@SpringBootTest
@Slf4j
public class PunishInfoServiceTest {

    @Autowired
    private IExcelImportService<PunishInfoBean> importService;

    @Test
    public void dataValidate() {
        importService.dataValidate("8B9B231B0AF4CDBBE053DC031EACDC13","sys");
    }

    @Test
    public void copyDataFromTemp() {
        importService.copyDataFromTemp("8B9B231B0AF4CDBBE053DC031EACDC13");
    }
}