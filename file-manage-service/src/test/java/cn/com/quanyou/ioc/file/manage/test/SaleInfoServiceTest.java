...
public class SaleInfoServiceTest {
    ...
    @Autowired
    private IExcelImportService<SaleInfoBean> importService;

    @Test
    public void dataValidate() {
        importService.dataValidate("8B9B231B052BCDBBE053DC031EACDC13","sys");
    }

    @Test
    public void copyDataFromTemp() {
        importService.copyDataFromTemp("8B9B231B052BCDBBE053DC031EACDC13");
    }
}