...
@SpringBootTest
@Slf4j
public class SaleTargetMonthServiceTest {

    @Autowired
    IExcelImportService<SaleTargetMonthBean> importService;

    @Test
    public void dataValidate() {
        importService.dataValidate("8B9B231B0758CDBBE053DC031EACDC13","sys");
    }

    @Test
    public void copyDataFromTemp() {
        importService.copyDataFromTemp("8B9B231B0758CDBBE053DC031EACDC13");
    }
}