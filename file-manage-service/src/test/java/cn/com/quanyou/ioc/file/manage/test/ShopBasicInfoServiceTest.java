 ...
 * @title: ShopBasicInfoServiceTest
...
@SpringBootTest
@Slf4j
public class ShopBasicInfoServiceTest {

    @Autowired
    IExcelImportService<ShopBasicInfoBean> importService;
    ...
    public void copyDataFromTemp() {
        importService.copyDataFromTemp("8B9B231B0B49CDBBE053DC031EACDC13");
    }
}